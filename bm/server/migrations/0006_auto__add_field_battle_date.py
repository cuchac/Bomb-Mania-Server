...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Battle.date'
        db.add_column('server_battle', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2010, 11, 15, 9, 32, 12, 167843), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Battle.date'
        db.delete_column('server_battle', 'date')
