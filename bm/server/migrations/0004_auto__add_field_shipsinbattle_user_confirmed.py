...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ShipsInBattle.user_confirmed'
        db.add_column('server_shipsinbattle', 'user_confirmed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ShipsInBattle.user_confirmed'
        db.delete_column('server_shipsinbattle', 'user_confirmed')
