...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ShipsInBattle.confirmed'
        db.add_column('server_shipsinbattle', 'confirmed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ShipsInBattle.confirmed'
        db.delete_column('server_shipsinbattle', 'confirmed')
