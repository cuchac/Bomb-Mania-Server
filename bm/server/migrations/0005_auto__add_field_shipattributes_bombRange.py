...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ShipAttributes.bombRange'
        db.add_column('server_shipattributes', 'bombRange', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ShipAttributes.bombRange'
        db.delete_column('server_shipattributes', 'bombRange')
