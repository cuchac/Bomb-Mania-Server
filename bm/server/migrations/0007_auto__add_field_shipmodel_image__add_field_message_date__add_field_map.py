...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ShipModel.image'
        db.add_column('server_shipmodel', 'image', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Message.date'
        db.add_column('server_message', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2010, 11, 15, 19, 35, 11, 590799), blank=True), keep_default=False)

        # Adding field 'Map.image'
        db.add_column('server_map', 'image', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ShipModel.image'
        db.delete_column('server_shipmodel', 'image')

        # Deleting field 'Message.date'
        db.delete_column('server_message', 'date')

        # Deleting field 'Map.image'
        db.delete_column('server_map', 'image')
