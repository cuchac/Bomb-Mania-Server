...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ShipsInBattle.confirmed'
        db.alter_column('server_shipsinbattle', 'confirmed', self.gf('django.db.models.fields.IntegerField')())


    def backwards(self, orm):
        
        # Changing field 'ShipsInBattle.confirmed'
        db.alter_column('server_shipsinbattle', 'confirmed', self.gf('django.db.models.fields.BooleanField')())
